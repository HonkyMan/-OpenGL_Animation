...
void mySpecialKeyFunc(int key, int x, int y)
{
    switch (key) {
    case GLUT_KEY_UP:
        if (AnimateStep < 1.0e3 && AnimateStep > 0) {         // Avoid overflow problems
            AnimateStep *= sqrt(2.0);      // Increase the angle increment
        }
        else if (AnimateStep < 0)
            AnimateStep *= -1;
        break;
    case GLUT_KEY_DOWN:
...
void drawScene(void)
{
    ...
    //
    glColor3f(0.3, 5.0, 0.3);

    glVertex3f(2.53, 0.71, 0.5);
    glVertex3f(2.46, 2.86, 0.0);
    glVertex3f(2.35, 2.71, 0.0);
    glVertex3f(2.25, 0.41, 0.0);

    //
    glColor3f(0.5, 0.5, 5.0);

    glVertex3f(0.667, 2.79, 0.5);
    glVertex3f(0.337, 0.786, 0.0);
    glVertex3f(0.597, 0.636, 0.0);
    glVertex3f(0.77, 2.5, 0.0);

    //
    glColor3f(5.0, 5.0, 0.5);

    glVertex3f(2.6, 2.5, 0.5);
    glVertex3f(2.535, 2.26, 0.5);
    glVertex3f(0.35, 2.35, 0.0);
    glVertex3f(0.41, 2.43, 0.0);
